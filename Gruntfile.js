module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    copy: {
      scripts: {
        ...
        rename: function (dest, src) {
          return dest + src.replace('scripts', 'login-dialog')
        }
      },
      styles: {
        expand: true,
    ...
    uglify: {
      dist: {
        files: {
          'dist/login-dialog.template.min.js': ['.tmp/scripts.template.js'],
          'dist/login-dialog.min.js': ['.tmp/scripts.js']
        }
      }
    },
    html2js: {
      dist: {
        ...
        module: 'eha.login-dialog.template',
        options: {
